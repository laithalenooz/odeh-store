...
{{-- page title --}}
@section('title','Privacy and Terms Create')
{{-- vendor styles --}}
...
@section('content')
<!-- Privacy and Terms create start -->
    ...
    <div class="card-body">
      <div class="tab-content">
        <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form action="{{route('termsandconditions.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="row">
                  <div class="col-12 col-sm-6">
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <textarea value="{{old('terms')}}" class="ckeditor" required class="form-control" placeholder="Terms and Conditions" name="terms"></textarea>
                            @if ($errors->has('terms'))
